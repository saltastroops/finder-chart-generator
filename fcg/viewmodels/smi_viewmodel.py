...
class SmiViewModel(FormBaseViewModel):
    def __init__(self, request: Request):
        ...
        self.smi_barcode: str = ""
        self.include_fibers: bool = False
    ...
    async def load(self) -> None:
        ...
        # SMI barcode
        self.smi_barcode = parse.parse_smi_barcode(form, self.errors)

        # include fibers?
        self.include_fibers = parse.parse_include_fibers(form, self.errors)
